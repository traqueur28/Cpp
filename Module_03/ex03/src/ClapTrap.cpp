...
/*   Updated: 2022/07/05 08:36:20 by jgourlin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(): _name("name"), _pdv(10), _pe(10), _ad(0){
    std::cout << "\033[34mvoid Constructor called ClapTrap" << std::endl;
}

ClapTrap::ClapTrap(ClapTrap const &cpy): _name(cpy._name), _pdv(cpy._pdv), _pe(cpy._pe), _ad(cpy._ad){
    std::cout << "\033[34mCopy Constructor called ClapTrap" << std::endl;
}

ClapTrap::ClapTrap(std::string name): _name(name), _pdv(10), _pe(10), _ad(0){
    std::cout << "\033[34mConstructor called ClapTrap" << std::endl;
}
